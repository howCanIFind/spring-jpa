...
class MemberRepositoryTest {
    ...
    @Test
    public void findByMemberAndAgeGreaterThen() {
    ...
    public void paging() {
        ...
        assertThat(content.size()).isEqualTo(3);
//        assertThat(pageSlice.getTotalElements()).isEqualTo(5);
        assertThat(pageSlice.getNumber()).isEqualTo(0);
//        assertThat(pageSlice.getTotalPages()).isEqualTo(2);
...
//        em.clear(); // clearAutomatically로 인해 없어도 됨.

        List<Member> result = memberRepository.findByUsername("member5");
        Member member5 = result.get(0);
        System.out.println("member5 = " + member5); // db와 영속성 컨텍스트의 member5 값이 다름. 여기서는 clear를 했기 대문에 값이 같음.
...
//        List<Member> members = memberRepository.findAll();
    ...
    public void queryHint() {
        ...
        //when
        Member findMember = memberRepository.findReadOnlyByUsername("member1"); // readOnly 이기 때문에 변경 감지 체크를 하지 않음.
//        findMember.setUsername("member2");
    ...
    public void lock() {
        ...
        //when
        List<Member> result = memberRepository.findLockByUsername("member1");// readOnly 이기 때문에 변경 감지 체크를 하지 않음.
//        findMember.setUsername("member2");
    ...
    public void Projections() {
        ...
        // Nested
        List<NestedClosedProjections> result3 = memberRepository.findProjections2ByUsername("m1", NestedClosedProjections.class);
